...
import { clearAuthError, login } from "@/redux/slices/auth-slice";
...
export function LoginForm() {
  ...
  return (
    <AuthLayout
      title="Welcome back"
      subtitle="Sign in to continue collaborating on your documents."
    >
      <Form {...form}>
            ...
            render={({ field }) => (
              <FormItem>
                <div className="flex items-center gap-3">
                  ...
                  <FormLabel className={cn("mt-0! font-normal text-muted-foreground")}>
                    Remember me
                  </FormLabel>
                </div>
              </FormItem>
